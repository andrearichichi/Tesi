...
\begin{figure}[h]
    \centering
    \frame{\includegraphics[scale=0.22]{img/Menu_iniziale.png}}
...
\begin{wrapfigure}{r}{0.55\textwidth}
    \centering
    \vspace{-0.4cm}
    \includegraphics[width=\linewidth]{img/ball_recognition.png}
...
\begin{wrapfigure}{r}{0.55\textwidth}
    \centering
    \vspace{-0.5cm}
    \includegraphics[width=\linewidth]{img/player_recognition.png}
